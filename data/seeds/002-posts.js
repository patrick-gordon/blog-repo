  ...
  return knex('posts').del()
    .then(function () {
      ...
      return knex('posts').insert([
        ...
        { title: 'title-11', contents: 'Success or failure: which is more destructive?', user_id: 1 },
        {
          title: 'title-4',
          contents:
        ...
        {title: 'title-6', contents: 'Beware of the barrenness of a busy life.', user_id: 2 },
        {
          title: 'title-7',
